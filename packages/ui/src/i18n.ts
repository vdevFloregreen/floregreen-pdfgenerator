...
const dictPtBr: { [key in keyof Dict]: string } = {
  cancel: 'Cancelar',
  close: 'Fechar',
  field: 'Campo',
  fieldName: 'Nome',
  ...
  editable: 'Editável',
  edit: 'Editar',
  plsInputName: 'Por favor, insira o nome',
  fieldMustUniq: 'O nome do campo não é único',
  notUniq: '(Nome não é único)',
  noKeyName: 'Sem nome',
  fieldsList: 'Lista de campos',
  editField: 'Editar campo',
  type: 'Tipo',
  ...
  errorBulkUpdateFieldName:
  'Não foi possível confirmar a alteração porque o número de itens mudou.',
  commitBulkUpdateFieldName: 'Confirmar alterações',
  bulkUpdateFieldName: 'Alterar nomes de campos em massa',
  addPageAfter: 'Adicionar uma página depois',
  removePage: 'Remover a página atual',
  removePageConfirm:
    'Tem certeza de que deseja remover esta página? Esta ação é irreversível.',
  'validation.hexColor': 'Por favor, insira um código de cor hexadecimal válido.',
  'validation.uniqueName': 'Por favor, insira um nome único.',
  'schemas.color': 'Cor',
  'schemas.borderWidth': 'Largura da borda',
  'schemas.borderColor': 'Cor da borda',
  'schemas.backgroundColor': 'Cor de fundo',
  ...
  'schemas.top': 'Topo',
  'schemas.middle': 'Meio',
  'schemas.bottom': 'Inferior',
  'schemas.padding': 'Preenchimento',
  ...
  'schemas.text.lineHeight': 'Altura da linha',
  'schemas.text.min': 'Mín',
  'schemas.text.max': 'Máx',
  'schemas.text.fit': 'Ajustar',
  'schemas.text.dynamicFontSize': 'Tamanho de fonte dinâmico',
  'schemas.text.format': 'Formato',
  'schemas.mvt.typingInstructions':
    'Adicione variáveis digitando palavras entre chaves, por ex.',
  'schemas.mvt.sampleField': 'nome',
  'schemas.mvt.variablesSampleData': 'Exemplos de dados de variáveis',
  'schemas.barcodes.barColor': 'Cor da barra',
  'schemas.barcodes.includetext': 'Incluir texto',
  'schemas.table.alternateBackgroundColor': 'Cor de fundo alternativa',
  'schemas.table.tableStyle': 'Estilo da tabela',
  'schemas.table.showHead': 'Exibir cabeçalho',
  'schemas.table.headStyle': 'Estilo do cabeçalho',
  'schemas.table.bodyStyle': 'Estilo do corpo',
  'schemas.table.columnStyle': 'Estilo da coluna',
  'schemas.date.format': 'Formato de data',
  'schemas.select.options': 'Opções',
  'schemas.select.optionPlaceholder': 'Digite uma opção',
  'schemas.radioGroup.groupName': 'Nome do grupo',
